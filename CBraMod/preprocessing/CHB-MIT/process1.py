...
# PARAMETERS
signals_path = r"/path/to/benchmark_data/chbmit/files/chbmit/1.0.0"  # Path to the data main directory
clean_path = r"/path/to/benchmark_data/chbmit/processed"  # Path where to store clean data
